...
| `scripts/build-standalone-repos.sh repo-padrao-laravel-vue` | Gera um template específico |
| `scripts/push-standalone-repos.sh` | Init/commit/push dos 14 repos no GitHub |
...
Cópias geradas dos 14 templates. Versionadas no meta-repo como espelho local; cada subpasta também existe como repositório independente em `https://github.com/filipefalcaofs/repo-padrao-*`.
