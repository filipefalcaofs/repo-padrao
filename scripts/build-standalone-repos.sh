...
Template **agnóstico** — Superpowers, rules universais e segundo cérebro, **sem stack** de linguagem.

## Quando usar

Use este repo se ainda não sabe a stack ou quer só disciplina de IA (TDD, pt-BR, ADRs).
...
Detalhes em [`docs/COMO_USAR.md`](docs/COMO_USAR.md) e [`AGENTS.md`](AGENTS.md).
EOF
}
